...
!(function (n, t) {
            ...
            }),
            {
                ...
                easeInOutBounce: function (n, t, r, e, i) {
                    return t < i / 2
                        ...
                        : 0.5 * this.easeOutBounce(n, 2 * t - i, 0, e, i) +
                              0.5 * e +
                              r;
                },
            }),
            ...
            (M[xi.p] = {
                ...
                trigger: function (n) {
                    ...
                    return this.each(function () {
                        ((t = this),
                            hi.createEvent
                                ? ((r = hi.createEvent("HTMLEvents")).initEvent(
                                      n,
                                      !0,
                                      !1,
                                  ),
    ...
    function m(n) {
        var t = !!n && [xi.l] in n && n[xi.l],
            r = d(n);
        return (
            !E(r) && (r == mi || 0 === t || (d(t) == yi && 0 < t && t - 1 in n))
        );
    }
    function g(n) {
    ...
    function N(n, t) {
        ...
        (!1 !== t && n.q.splice(0, 1),
            0 < n.q[xi.l]
                ? ((e = n.q[0]),
                  x(n.el, e.props, e.duration, e.easing, e.complete, !0))
        ...
        if (d(n) == gi)
            for (
                i = [],
                    t =
                        "<" === n.charAt(0)
                            ? (((r = hi.createElement("div")).innerHTML = n),
                              r.children)
    ...
    function K(r, n, t, xt, _t) {
        ...
        if (ht(r)) {
            ...
            return (
                ...
                (Ot.removeExt = function (n) {
                    ...
                    return (
                        !!r &&
                        (delete jn[n], (t = r.removed), cn(t) == bi && t(), !0)
                    );
                }),
                ki.valid(
                    (function yt(n, t, r) {
                        ...
                        return (
                            ...
                            St.x &&
                            St.y &&
                            !Vt.nativeScrollbarsOverlaid.initialize
                ...
                if (t) {
                    if (T)
                        ((k = n
                            .addClass("observed")
                            .append(ui(On))
                            .contents()[0])[Z] = new r(u)).observe(k);
                    else if (9 < D || !kt) {
                        n.prepend(
                            ui(
                                On,
                            ...
                            (z.setAttribute(xi.ti, "-1"),
                                ...
                                (z.onload = function () {
                                    ...
                                    (n.addEventListener("resize", u),
                                        (n.document.documentElement.style.display =
                                            "none"));
                                }),
                                (z.type = "text/html"),
                                S && n.prepend(z),
        ...
        function qe(n) {
            ...
            if (
                ...
                (o &&
                    (Kt.find("*").trigger(we), Wt && Gt.find("*").trigger(we)),
                ...
                if (
                    ...
                    if (((ln = {}), V || en || fn))
                        if (Qt && rn) {
                            var et = nr.css(be),
                                it = Si.round(
                                    nr.css(be, me).css(le, me).position().left,
                                );
                            (nr.css(be, et),
                                it !== Si.round(nr.position().left) &&
                                    (ln[le] = it));
                        } else ln[le] = me;
                    if ((nr.css(ln), Lt && i)) {
                        var ot = (function yt() {
            ...
            Lt ||
                mt(function (n, t) {
                    nr.find(t).each(function (n, t) {
                        Oi.inA(t, Qn) < 0 &&
                            (Qn.push(t), Ci(t).off(Bn, rt).on(Bn, rt));
                    });
                });
        }
        function ot(n) {
        ...
        function ut(e) {
            var n = "parent",
                ...
                u = function () {
                    ...
                    h(o, function (n, t) {
                        cn(t) == gi &&
                            (n == xi.c ? r.addClass(t) : r.attr(n, t));
                    });
                },
                f = [
                    rn,
        ...
        function ct(S) {
            ...
            function N(n) {
                if (
                    ...
                    v(),
                    z !== (C = i = di) &&
                        (Ot.scrollStop(), clearTimeout(z), (z = di)),
                    n)
                ) {
                    var t = ur[xi.bCR]();
                    ((n.clientX >= t.left &&
                ...
                var r,
                    e = function () {
                        B ||
                            Et ||
                            (!(r =
                                l.hasClass("active") || m.hasClass("active")) &&
                                (Yr || Gr || Kr) &&
                                ci(a, Ln),
                            !r && (Yr || Gr || Kr) && ci(v, Ln));
                    };
