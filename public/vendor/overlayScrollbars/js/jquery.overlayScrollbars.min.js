    ...
    function z(r, n, t, xt, _t) {
        ...
        if (dt(r)) {
            ...
            return (
                ...
                (St.removeExt = function (n) {
                    ...
                    return (
                        !!r &&
                        (delete Pn[n], (t = r.removed), cn(t) == bi && t(), !0)
                    );
                }),
                zi.valid(
                    (function wt(n, t, r) {
                        ...
                        return (
                            ...
                            zt.x &&
                            zt.y &&
                            !qt.nativeScrollbarsOverlaid.initialize
        ...
        function Pe(n, t) {
            if (n) {
                var r = Si.rO(),
                    ...
                    o = 3333333,
                    a = function () {
                        (n[Se](o)[_e](Vt ? (Ot.n ? -o : Ot.i ? 0 : o) : o),
                            t());
                    };
                if (t) {
                    if (A)
                        ((k = n
                            .addClass("observed")
                            .append(ai(Sn))
                            .contents()[0])[Z] = new r(a)).observe(k);
                    else if (9 < I || !kt) {
                        n.prepend(
                            ai(
                                Sn,
                        ...
                        if (S)
                            (n.prepend(ai(Sn)),
                                gt(n, W + Sn)[0].attachEvent("onresize", a));
                        else {
        ...
        function Xe(n) {
            ...
            if (
                ...
                (o &&
                    (Jt.find("*").trigger(ge), Mt && Gt.find("*").trigger(ge)),
                ...
                if (
                    ...
                    if (((ln = {}), q || en || un))
                        if (Vt && rn) {
                            var et = nr.css(be),
                                it = Oi.round(
                                    nr.css(be, ye).css(le, ye).position().left,
                                );
                            (nr.css(be, et),
                                it !== Oi.round(nr.position().left) &&
                                    (ln[le] = it));
                        } else ln[le] = ye;
                    if ((nr.css(ln), Nt && i)) {
                        var ot = (function wt() {
            ...
            Nt ||
                yt(function (n, t) {
                    nr.find(t).each(function (n, t) {
                        Si.inA(t, Vn) < 0 &&
                            (Vn.push(t), Ci(t).off(Un, rt).on(Un, rt));
                    });
                });
        }
        function ot(n) {
        ...
        function ct(z) {
            ...
            function D(n) {
                if (
                    ...
                    v(),
                    T !== (O = i = hi) &&
                        (St.scrollStop(), clearTimeout(T), (T = hi)),
                    n)
                ) {
                    var t = ar[xi.bCR]();
                    ((n.clientX >= t.left &&
                ...
                var r,
                    e = function () {
                        U ||
                            Lt ||
                            (!(r =
                                l.hasClass("active") || y.hasClass("active")) &&
                                (Kr || Gr || Jr) &&
                                ci(f, Nn),
                            !r && (Kr || Gr || Jr) && ci(v, Nn));
                    };
