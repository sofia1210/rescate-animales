...
function T(e, t, o = !1) {
    ...
    return (
        (i && !o ? t.contains(a) : t === a && "BODY" !== a.nodeName) &&
            (u = y(u, t)),
        u
    );
}
...
class ve {
    constructor(e, t, o = {}) {
        ((this.scheduleUpdate = () => requestAnimationFrame(this.update)),
            ...
            Object.keys(O({}, ve.Defaults.modifiers, o.modifiers)).forEach(
                (e) => {
