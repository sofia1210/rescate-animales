 ...
 */ (function (a, b) {
    ...
    function g(a) {
        ...
        for (
            var c = f(10) ? document.body : null, d = a.offsetParent || null;
            d === c && a.nextElementSibling;
    ...
    function r(a, c) {
        var e = 2 < arguments.length && void 0 !== arguments[2] && arguments[2],
            ...
            k = d(a),
            m = b(c),
            n = parseFloat(m.borderTopWidth),
            o = parseFloat(m.borderLeftWidth);
        e && h && ((j.top = R(j.top, 0)), (j.left = R(j.left, 0)));
        var r = p({
            top: i.top - j.top - n,
        ...
        if (((r.marginTop = 0), (r.marginLeft = 0), !g && h)) {
            var s = parseFloat(m.marginTop),
                t = parseFloat(m.marginLeft);
            ((r.top -= n - s),
                (r.bottom -= n - s),
                (r.left -= o - t),
                (r.right -= o - t),
        ...
        return (
            (g && !e ? c.contains(k) : c === k && "BODY" !== k.nodeName) &&
                (r = l(r, c)),
            r
        );
    }
    ...
    function u(a) {
        ...
        for (var c = a.parentElement; c && "none" === b(c, "transform"); )
            c = c.parentElement;
    ...
    function v(a, b, f, g) {
        ...
        if ("viewport" === g) i = s(k, h);
            ...
            "scrollParent" === g
                ...
                : "window" === g
                  ...
                  : (l = g);
            var m = r(l, k, h);
            if ("HTML" === l.nodeName && !t(k)) {
                var n = o(a.ownerDocument),
                    p = n.height,
                    q = n.width;
                ((i.top += m.top - m.marginTop),
                    (i.bottom = p + m.top),
                    (i.left += m.left - m.marginLeft),
                    (i.right = q + m.left));
            } else i = m;
        }
        f = f || 0;
        ...
        return (
            (i.left += v ? f : f.left || 0),
            (i.top += v ? f : f.top || 0),
            (i.right -= v ? f : f.right || 0),
            (i.bottom -= v ? f : f.bottom || 0),
            i
        );
    }
    function w(a) {
    ...
    function M(a, b, c) {
        ...
        return (
            d.forEach(function (a) {
                ...
                a.enabled &&
                    G(c) &&
                    ((b.offsets.popper = p(b.offsets.popper)),
                    (b.offsets.reference = p(b.offsets.reference)),
                    (b = c(b, a)));
            }),
            b
        );
    ...
    function P(a, b, c, e) {
        ...
        (g.addEventListener(b, c, { passive: !0 }),
            f || P(d(g.parentNode), b, c, e),
            e.push(g));
    }
    function Q(a, b, c, e) {
        ((c.updateBound = e),
            K(a).addEventListener("resize", c.updateBound, { passive: !0 }));
        var f = d(a);
        return (
            P(f, "scroll", c.updateBound, c.scrollParents),
            (c.scrollElement = f),
            (c.eventsEnabled = !0),
            c
        );
    ...
    var R = Math.max,
        ...
        W = (function () {
            for (
                ...
                if (S && 0 <= navigator.userAgent.indexOf(a[b])) return 1;
            return 0;
        })(),
        X = S && window.Promise,
        Y = X
