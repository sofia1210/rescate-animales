...
var e =
    ...
    f = e && !!(window.MSInputMethodContext && document.documentMode),
...
function i(b) {
    ...
    for (
        var c = h(10) ? document.body : null, d = b.offsetParent || null;
        d === c && b.nextElementSibling;
...
function t(b) {
    ...
    var f = {
        ...
        g = "HTML" === b.nodeName ? q(b.ownerDocument) : {},
        i = g.width || b.clientWidth || f.width,
        j = g.height || b.clientHeight || f.height,
        k = b.offsetWidth - i,
        l = b.offsetHeight - j;
    if (k || l) {
        var n = a(b);
...
function u(b, d) {
    ...
    if (((q.marginTop = 0), (q.marginLeft = 0), !g && i)) {
        var r = parseFloat(m.marginTop),
            u = parseFloat(m.marginLeft);
        ((q.top -= o - r),
            (q.bottom -= o - r),
            (q.left -= p - u),
            (q.right -= p - u),
    ...
    return (
        (g && !f ? d.contains(l) : d === l && "BODY" !== l.nodeName) &&
            (q = n(q, d)),
        q
    );
}
...
function x(b) {
    ...
    for (var c = b.parentElement; c && "none" === a(c, "transform"); )
        c = c.parentElement;
...
function y(a, e, f, g) {
    ...
    if ("viewport" === g) i = v(j, h);
        ...
        "scrollParent" === g
            ? ((k = c(b(e))),
              "BODY" === k.nodeName && (k = a.ownerDocument.documentElement))
            : "window" === g
              ? (k = a.ownerDocument.documentElement)
              : (k = g);
        var m = u(k, j, h);
        if ("HTML" === k.nodeName && !w(j)) {
            var n = q(a.ownerDocument),
                o = n.height,
                p = n.width;
    ...
    f = f || 0;
    var r = "number" == typeof f;
    return (
        (i.left += r ? f : f.left || 0),
        (i.top += r ? f : f.top || 0),
        (i.right -= r ? f : f.right || 0),
        (i.bottom -= r ? f : f.bottom || 0),
        i
    );
}
function z(a) {
