 ...
 */ var e =
    ...
    t = (function () {
        for (
            var t = ["Edge", "Trident", "Firefox"], o = 0;
            o < t.length;
            o += 1
        )
...
function c(e) {
    ...
    for (
        var t = h(10) ? document.body : null, o = e.offsetParent || null;
...
function B(e, t, o, n) {
    ...
    return (
        (r.left += g ? o : o.left || 0),
        (r.top += g ? o : o.top || 0),
        (r.right -= g ? o : o.right || 0),
        (r.bottom -= g ? o : o.bottom || 0),
        r
    );
}
function H(e) {
...
function _(e, t, o, n) {
    ...
    (r.addEventListener(t, o, { passive: !0 }),
        i || _(a(r.parentNode), t, o, n),
        n.push(r));
}
function X(e, t, o, n) {
    ((o.updateBound = n),
        G(e).addEventListener("resize", o.updateBound, { passive: !0 }));
    var i = a(e);
    return (
        _(i, "scroll", o.updateBound, o.scrollParents),
        (o.scrollElement = i),
        (o.eventsEnabled = !0),
        o
    );
...
function ne(e, t, o, n, i) {
    ...
    return (
        ...
        ee(t, { position: o.positionFixed ? "fixed" : "absolute" }),
        o
    );
}
function ie(e, t) {
...
function pe(e, t) {
    ...
    return (
        (e.attributes = T({}, y, e.attributes)),
        (e.styles = T({}, f, e.styles)),
...
function de(e, t) {
    ...
    var i = e.placement.split("-")[0],
        ...
        c = a ? "bottom" : "right",
        g = F(n)[l];
    (d[c] - g < p[m] && (e.offsets.popper[m] -= p[m] - (d[c] - g)),
        d[m] + g > p[c] && (e.offsets.popper[m] += d[m] + g - p[c]),
...
var Oe = {
        ...
        arrow: { order: 500, enabled: !0, fn: de, element: "[x-arrow]" },
        flip: {
            order: 600,
            enabled: !0,
            fn: ce,
        ...
        inner: { order: 700, enabled: !1, fn: ve },
