...
@section('title', 'Nuevo Rescatista - Rescate Animales')
...
<div class="content-header">
	<div class="container-fluid">
		<div class="row mb-2">
			<div class="col-sm-6">
				<h1 class="m-0">Registrar Rescatista</h1>
			</div>
			<div class="col-sm-6">
				<ol class="breadcrumb float-sm-right">
					<li class="breadcrumb-item"><a href="{{ route('rescatistas.index') }}">Rescatistas</a></li>
			...
			<div class="card-body">
				<form id="form">
					...
					<div class="text-right">
						<a href="{{ route('rescatistas.index') }}" class="btn btn-secondary">Cancelar</a>
