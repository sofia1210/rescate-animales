...
@section('title', 'Seleccionar Veterinario - Tratamiento')
...
function seleccionarVeterinario(id, nombre) {
    ...
    sessionStorage.setItem('veterinarioSeleccionadoTratamiento', JSON.stringify({
        id: id,
        nombre: nombre
    }));
    
    // Redirigir al formulario de tratamiento
    window.location.href = "{{ route('animales.tratamiento') }}";
}
